package com.sil.it.copy.fragment;
...
public class IDFragment extends Fragment {
    ...
    int[] d = {R.drawable.a, R.drawable.b, R.drawable.c, R.drawable.d, R.drawable.g};
    ...
    private void initViews(View view) {
        ids = (ImageView) view.findViewById(R.id.ids);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        initViews(view);
        ids.setImageResource(d[Integer.valueOf(mParam1)]);
    }
}
